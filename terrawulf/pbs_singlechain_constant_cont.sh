...
export HIERARCHICALPRIORFILE=$GENERALBASE/terrawulf/hierarchical_prior.txt

export INPUT_DIR=$GENERALBASE/terrawulf/constant_mpi_$SRCSTEP/
export RESULTS_DIR=$GENERALBASE/terrawulf/constant_mpi_$DSTSTEP/

export GENERALARGS="-i $GENERAL_OBS -I $INPUT_DIR -o $RESULTS_DIR -P $PRIORFILE -M $POSITIONPRIORFILE -t 1000000 -v 1000 -T 200 -l 1.0 -H $HIERARCHICALPRIORFILE"
